...
# target  class 
# classmetho get all to show
# classmetho add_author to add
#  classmetho unfavorited_authors
# get by id
...
class Author:
    ...
    def get_by_id(cls,data):
        query = """SELECT * FROM authors LEFT JOIN 
        favorites ON authors.id = favorites.author_id 
